...
set(files_to_change
    "${CMAKE_INSTALL_PREFIX}/${CMAKE_CONFIG_DESTINATION}/${TARGET_EXPORT_NAME}.cmake"
)

foreach(build_type IN ITEMS debug release)
    set(filename "${CMAKE_INSTALL_PREFIX}/${CMAKE_CONFIG_DESTINATION}/${TARGET_EXPORT_NAME}-${build_type}.cmake")
    if (EXISTS "${filename}")
