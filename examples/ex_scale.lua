...
--[[
Sources:
    https://github.com/liballeg/allegro5/blob/5.2.11.3/examples/ex_scale.c
--]]
...
local function main()
    ...
    if not mem_bmp then
        abort_example("Unable to load image" .. env.ALLEGRO_EXAMPLES_DATA_PATH .. "/mysha\n")
    end

    local bmp_w = allegro5.al_get_bitmap_width(bmp)
    local bmp_h = allegro5.al_get_bitmap_height(bmp)
    ...
    while true do
       ...
       --]]
        ...
        if trans_mode then
            ...
            tint = allegro5.al_map_rgba_f(1, 1, 1, 0.5)
        end
        ...
        allegro5.al_draw_tinted_scaled_bitmap(src_bmp, tint,
            0, 0, bmp_w, bmp_h,
